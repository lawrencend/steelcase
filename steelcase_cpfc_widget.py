...
from steelcase_cpfc_ui import Ui_cpfc_widget

class Cpfc_widget(QtGui.QWidget):

    def __init__(self, parent=None):
        """ Start_steelcase init method. """

        # init parent classes
        super(Cpfc_widget, self).__init__()

        #Ui instance
        self.ui = Ui_cpfc_widget()

        # Setup ui
        self.ui.setupUi(self)

        QtCore.QObject.connect(self.ui.apply_push_button,
    ...
    def cpfc(self):
        ...
        self.current_pfc = self.check_input(self.ui.cpfc_line_edit)
